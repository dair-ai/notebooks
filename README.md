...
![](https://github.com/dair-ai/notebooks/workflows/CI/badge.svg) 
![](https://github.com/dair-ai/notebooks/workflows/GH-Pages%20Status/badge.svg) 
...
Sharing is easy! Just upload your notebooks to the `_notebooks` folder and it will be featured on our [website](https://dair.ai/notebooks/). The notebooks will shared in our weekly newsletter which is read by thousands of avid learners.
...
3) You can then upload your notebook directly to the [`_notebooks`](https://github.com/dair-ai/notebooks/tree/master/_notebooks) folder. Ensure that the notebook follows the following naming convention: `YYYY-MM-DD-Name-of-your-notebook.ipynb`. Check the examples [here](https://github.com/dair-ai/notebooks/tree/master/_notebooks).
